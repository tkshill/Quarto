...
type Model
    ...
    | GamePage_Model Pages.GamePage.Model
    | NotFound_Model Pages.NotFound.Model


type Msg
    = Top_Msg Pages.Top.Msg
    | GamePage_Msg Pages.GamePage.Msg
...
type alias UpgradedPages =
    ...
    , gamePage : UpgradedPage Pages.GamePage.Flags Pages.GamePage.Model Pages.GamePage.Msg
...
pages =
    ...
    , gamePage = Pages.GamePage.page |> Page.upgrade GamePage_Model GamePage_Msg
...
update bigMsg bigModel =
    case ( bigMsg, bigModel ) of
        ...
        ( GamePage_Msg msg, GamePage_Model model ) ->
            pages.gamePage.update msg model
...
bundle bigModel =
    case bigModel of
        ...
        GamePage_Model model ->
            pages.gamePage.bundle model
